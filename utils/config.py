...
eval_data_path = os.path.join(root_dir, "dataset/final/valid.bin")
decode_data_path = os.path.join(root_dir, "dataset/final/test.bin")
vocab_path = os.path.join(root_dir, "dataset/final/vocab")
